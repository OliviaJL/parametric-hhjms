...
#HHJMs_tmp = makeExperimentRegistry("HHJMs_simul0720", packages = "HHJMs", seed = 20071552)
#HHJMs_tmp$cluster.functions = makeClusterFunctionsMulticore(ncpus = ncpus)
#getDefaultRegistry()
loadRegistry(file.dir="results/HHJMs_simul0720-4", writeable = TRUE)
...
## add the experiment --------------------------------------------------------------
addExperiments(problem_designs, algo_designs, repls = 5L, combine = 'crossprod') # of replicates = 500
